...
const ChatInput = ({chatMessages, setChatMessages}) => {
    ...
    setChatMessages([
        ...newChatMessages,
        {
            message: <img src={loadingSpinner} className="h-[40px]" />,
            sender: 'robot',
            id: crypto.randomUUID()
        }
    ])
    ...
    return (
        <div className="fixed bottom-0 inset-x-50 flex flex-col items-center justify-center w-[90%] nm:w-[850px]">
            ...
            onKeyDown={handleKey}
            placeholder="Send a message to AI-chat"
            rows={1}
